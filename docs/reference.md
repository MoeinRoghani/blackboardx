...
| --- | --- | --- |
| `blackboard` | The board, the control component, `create_model`, the `AgentBoard` an agent body is written against, and the scheduled work: `close_expired` and `Sweep` | The blackboard and the agent |
