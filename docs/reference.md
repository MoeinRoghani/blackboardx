...
| --- | --- | --- |
| `blackboard` | The board, the control component, `create_model`, the `AgentBoard` an agent body is written against, and the scheduled work: `close_expired`, `relay_unsent` and `Sweep` | The blackboard and the agent |
