...
| --- | --- | --- |
| `blackboard` | The board, the control component, `create_model`, `close_expired`, and the `AgentBoard` an agent body is written against | The blackboard and the agent |
